...
class Dataset_Price_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='MS', data_path='DE.csv',
    ...
    def __read_data__(self):
        ...
        border1s = [0, 12 * 30 * 24 * 3 + 4 * 30 * 24 - self.seq_len, 12 * 30 * 24 * 4 + 8 * 30 * 24 - self.seq_len]
        border2s = [12 * 30 * 24 * 3 + 4 * 30 * 24, 12 * 30 * 24 * 4 + 8 * 30 * 24, 12 * 30 * 24 * 4 + 12 * 30 * 24 * 2] #4 y 8m 1y4m
