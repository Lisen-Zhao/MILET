...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='./data/Price/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='VMD_SE_DE.csv', help='data file')
    ...
    parser.add_argument('--enc_in', type=int, default=6, help='encoder input size') #dim
